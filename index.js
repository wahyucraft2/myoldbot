...
//
const BotName = 'Wahyu Septiaji BOT {BETA}'; // jangan di ubah...bila di ubah eror.      BOT BY MASLENT 
const instagramlu = 'https://instagram.com/whedtz_'; // jangan di ubah...bila di ubah eror
const whatsapplu = 'wa/me +6289523072881'; // jangan di ubah...bila di ubah eror
const kapanbotaktif = '24 hours'; // jangan di ubah...bila di ubah eror
const grupch1 = 'https://chat.whatsapp.com/BAJxiz5F4BlASMgP4EWmcq'; // jangan di ubah...bila di ubah eror
const grupch2 = 'https://chat.whatsapp.com/BAJxiz5F4BlASMgP4EWmcq'; // jangan di ubah...bila di ubah eror
//
const
{
   WAConnection,
...
conn.on('qr', qr =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] Scan yaa`);
});
...
conn.sendMessage(id, 'wa/me +6289523072881' ,MessageType.text);
}
